        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 lg:gap-10 xl:gap-12 mb-6 sm:mb-8 md:mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2 sm:space-y-2.5 md:space-y-3">
              <li>
                <Link to="/products" className="text-gray-400 text-xs sm:text-sm md:text-base transition-all duration-300 hover:text-blue-400 hover:pl-2 flex items-center gap-2 group">
              ...
              <li>
                <Link to="/categories" className="text-gray-400 text-xs sm:text-sm md:text-base transition-all duration-300 hover:text-blue-400 hover:pl-2 flex items-center gap-2 group">
                  <svg className="w-3 h-3 sm:w-4 sm:h-4 opacity-0 group-hover:opacity-100 transition-opacity flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                  </svg>
                  Categories
              ...
              <li>
                <Link to="/prescription-upload" className="text-gray-400 text-xs sm:text-sm md:text-base transition-all duration-300 hover:text-blue-400 hover:pl-2 flex items-center gap-2 group">
                  <svg className="w-3 h-3 sm:w-4 sm:h-4 opacity-0 group-hover:opacity-100 transition-opacity flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                  </svg>
                  Upload Prescription
              ...
              <li>
                <Link to="/about" className="text-gray-400 text-xs sm:text-sm md:text-base transition-all duration-300 hover:text-blue-400 hover:pl-2 flex items-center gap-2 group">
                  <svg className="w-3 h-3 sm:w-4 sm:h-4 opacity-0 group-hover:opacity-100 transition-opacity flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                  </svg>
                  About Us
          ...
          <div>
            ...
            <ul className="space-y-2 sm:space-y-2.5 md:space-y-3">
              <li>
                <Link to="/contact" className="text-gray-400 text-xs sm:text-sm md:text-base transition-all duration-300 hover:text-blue-400 hover:pl-2 flex items-center gap-2 group">
                  <svg className="w-3 h-3 sm:w-4 sm:h-4 opacity-0 group-hover:opacity-100 transition-opacity flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                  </svg>
                  Contact Us
              ...
              <li>
                <Link to="/shipping" className="text-gray-400 text-xs sm:text-sm md:text-base transition-all duration-300 hover:text-blue-400 hover:pl-2 flex items-center gap-2 group">
                  <svg className="w-3 h-3 sm:w-4 sm:h-4 opacity-0 group-hover:opacity-100 transition-opacity flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                  </svg>
                  Shipping Policy
              ...
              <li>
                <Link to="/returns" className="text-gray-400 text-xs sm:text-sm md:text-base transition-all duration-300 hover:text-blue-400 hover:pl-2 flex items-center gap-2 group">
                  <svg className="w-3 h-3 sm:w-4 sm:h-4 opacity-0 group-hover:opacity-100 transition-opacity flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                  </svg>
                  Return Policy
              ...
              <li>
                <Link to="/faq" className="text-gray-400 text-xs sm:text-sm md:text-base transition-all duration-300 hover:text-blue-400 hover:pl-2 flex items-center gap-2 group">
                  <svg className="w-3 h-3 sm:w-4 sm:h-4 opacity-0 group-hover:opacity-100 transition-opacity flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                  </svg>
                  FAQ
