    ...
    <div className="container-custom py-12">
      ...
      {orders.length === 0 ? (
        ...
        <div className="space-y-6">
          {orders.map(order => (
            <div key={order.id} className="bg-white p-8 rounded-xl shadow-md border border-gray-200 hover:shadow-lg transition-shadow">
              <div className="flex justify-between items-start mb-6">
                ...
                <div className="text-right">
                  <span className={`inline-flex items-center gap-2 px-4 py-2 rounded-full border font-bold text-sm capitalize ${getStatusColor(order.status)}`}>
