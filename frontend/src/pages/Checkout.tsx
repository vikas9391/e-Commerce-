...
const Checkout = () => {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      notification.className = 'fixed top-20 sm:top-24 right-4 sm:right-8 bg-green-500 text-white px-4 sm:px-6 py-3 sm:py-4 rounded-lg shadow-lg z-50 flex items-center gap-2 sm:gap-3 max-w-sm';
      notification.innerHTML = `
        <svg class="w-5 h-5 sm:w-6 sm:h-6 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
        </svg>
        <span class="text-sm sm:text-base">Order placed successfully!</span>
      `;
          ...
          <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
            ...
            <div className="bg-white p-4 sm:p-6 md:p-8 rounded-xl shadow-md border border-gray-200">
              ...
              <div className="space-y-2 sm:space-y-3">
                <label className="flex items-start sm:items-center p-3 sm:p-4 border-2 border-gray-200 rounded-lg cursor-pointer hover:border-blue-600 transition-colors active:bg-blue-50">
                  <input 
                    type="radio" 
                    name="payment" 
                    value="card"
                  ...
                  <div className="ml-2 sm:ml-3 flex items-start sm:items-center gap-2 sm:gap-3 flex-1 min-w-0">
                    <svg className="w-5 h-5 sm:w-6 sm:h-6 text-gray-600 flex-shrink-0 mt-0.5 sm:mt-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z" />
                    </svg>
                    <div className="flex-1 min-w-0">
                      <p className="font-semibold text-gray-900 text-sm sm:text-base">Credit / Debit Card</p>
