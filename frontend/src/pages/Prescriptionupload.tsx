...
const PrescriptionUpload = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-cyan-50 py-6 sm:py-8 md:py-12">
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-6 sm:mb-8 md:mb-12">
          ...
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-heading font-extrabold text-gray-900 mb-2 sm:mb-3 md:mb-4 px-4">
            Upload Prescription
          </h1>
          ...
          <div className="max-w-3xl mx-auto">
            <div className="bg-white rounded-2xl shadow-lg p-4 sm:p-6 md:p-8 mb-4 sm:mb-6">
              ...
              <div
                ...
                className="border-2 border-dashed border-blue-300 rounded-xl p-6 sm:p-8 md:p-12 text-center hover:border-blue-500 transition-colors cursor-pointer bg-blue-50/50 active:bg-blue-100/50"
                ...
                {previewUrl ? (
                  <div className="space-y-3 sm:space-y-4">
                    <img
                      ...
                      className="max-h-48 sm:max-h-64 md:max-h-96 mx-auto rounded-lg shadow-md object-contain"
                    />
                    <p className="text-xs sm:text-sm text-gray-600 break-all px-2">{selectedFile?.name}</p>
                    <button
                      onClick={(e) => {
                        e.stopPropagation();
                        handleReset();
                  ...
                  <div className="space-y-3 sm:space-y-4">
                    <svg className="w-12 h-12 sm:w-16 sm:h-16 md:w-20 md:h-20 mx-auto text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12" />
                    </svg>
                    <div>
                      <p className="text-base sm:text-lg md:text-xl font-semibold text-gray-900 mb-1 sm:mb-2 px-2">
              ...
              {selectedFile && (
                <div className="mt-4 sm:mt-6">
                  <button
                    ...
                    className="w-full py-3 sm:py-4 px-4 sm:px-6 bg-gradient-to-r from-blue-600 to-cyan-600 text-white rounded-lg font-heading font-bold text-sm sm:text-base md:text-lg transition-all duration-300 hover:shadow-xl hover:-translate-y-1 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none active:scale-95"
                  >
                    {isProcessing ? (
            ...
            <div className="bg-white rounded-2xl shadow-lg p-4 sm:p-6 md:p-8">
              <h2 className="text-lg sm:text-xl md:text-2xl font-heading font-bold text-gray-900 mb-3 sm:mb-4">
                How it works
              </h2>
              <div className="space-y-3 sm:space-y-4">
                <div className="flex items-start gap-2 sm:gap-3 md:gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <h3 className="font-semibold text-gray-900 mb-1 text-sm sm:text-base">Upload Prescription</h3>
                    <p className="text-xs sm:text-sm text-gray-600">Take a clear photo of your prescription or upload an existing image</p>
                  </div>
                </div>
                <div className="flex items-start gap-2 sm:gap-3 md:gap-4">
                  <div className="w-7 h-7 sm:w-8 sm:h-8 bg-blue-600 text-white rounded-full flex items-center justify-center font-bold flex-shrink-0 text-sm sm:text-base">
                  ...
                  <div className="flex-1 min-w-0">
                    <h3 className="font-semibold text-gray-900 mb-1 text-sm sm:text-base">Automatic Detection</h3>
                    <p className="text-xs sm:text-sm text-gray-600">Our system automatically reads and extracts medicine names from your prescription</p>
                  </div>
                </div>
                <div className="flex items-start gap-2 sm:gap-3 md:gap-4">
                  <div className="w-7 h-7 sm:w-8 sm:h-8 bg-blue-600 text-white rounded-full flex items-center justify-center font-bold flex-shrink-0 text-sm sm:text-base">
                  ...
                  <div className="flex-1 min-w-0">
                    <h3 className="font-semibold text-gray-900 mb-1 text-sm sm:text-base">Find & Order</h3>
                    <p className="text-xs sm:text-sm text-gray-600">Review available medicines and add them to your cart with one click</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        {uploadStep === 'processing' && (
          <div className="max-w-3xl mx-auto">
            <div className="bg-white rounded-2xl shadow-lg p-6 sm:p-8 md:p-12 text-center">
              ...
              <h2 className="text-xl sm:text-2xl md:text-3xl font-heading font-bold text-gray-900 mb-3 sm:mb-4 px-4">
        ...
        {uploadStep === 'results' && (
          <div className="max-w-6xl mx-auto space-y-4 sm:space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center px-4">
              <button
                onClick={handleReset}
                className="inline-flex items-center justify-center gap-2 px-4 sm:px-6 py-2.5 sm:py-3 bg-white border-2 border-blue-600 text-blue-600 rounded-lg font-heading font-bold text-sm sm:text-base transition-all duration-300 hover:bg-blue-50 active:scale-95"
              >
                <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              {foundProducts.length > 0 && (
                <Link
                  to="/cart"
                  className="inline-flex items-center justify-center gap-2 px-4 sm:px-6 py-2.5 sm:py-3 bg-gradient-to-r from-blue-600 to-cyan-600 text-white rounded-lg font-heading font-bold text-sm sm:text-base transition-all duration-300 hover:shadow-xl active:scale-95"
                >
                  <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="bg-white rounded-2xl shadow-lg p-4 sm:p-6 md:p-8">
                ...
                <div className="flex flex-wrap gap-2">
                  {extractedMedicines.map((med, index) => (
                    <span
                      key={index}
                      className="inline-flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-1.5 sm:py-2 bg-blue-100 text-blue-800 rounded-lg font-semibold text-xs sm:text-sm"
                    >
                      <span className="break-all">{med.name}</span>
              ...
              <div className="bg-white rounded-2xl shadow-lg p-4 sm:p-6 md:p-8">
                <div className="flex items-start gap-3 sm:gap-4 mb-3 sm:mb-4">
                  <div className="w-8 h-8 sm:w-10 sm:h-10 bg-amber-100 rounded-full flex items-center justify-center flex-shrink-0">
                    <svg className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 text-amber-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
                    </svg>
                  </div>
                  <div className="flex-1 min-w-0">
                    <h2 className="text-lg sm:text-xl md:text-2xl font-heading font-bold text-gray-900 mb-2">
                      Not Available
                    </h2>
                    ...
                    <div className="space-y-2">
                      {notFoundMedicines.map((medicine, index) => (
                        <div key={index} className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 p-2.5 sm:p-3 bg-gray-50 rounded-lg">
                          <span className="font-semibold text-gray-900 text-xs sm:text-sm md:text-base break-all">{medicine}</span>
                          <Link
                            to="/contact"
                            className="text-blue-600 hover:text-blue-700 font-semibold text-xs sm:text-sm whitespace-nowrap text-right sm:text-left"
                          >
                            Contact Us
                          </Link>
                        </div>
            ...
            {foundProducts.length === 0 && notFoundMedicines.length === 0 && (
              <div className="bg-white rounded-2xl shadow-lg p-6 sm:p-8 md:p-12 text-center">
                <svg className="w-12 h-12 sm:w-16 sm:h-16 md:w-20 md:h-20 mx-auto text-gray-400 mb-3 sm:mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.172 16.172a4 4 0 015.656 0M9 10h.01M15 10h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                <h2 className="text-lg sm:text-xl md:text-2xl font-heading font-bold text-gray-900 mb-2 px-4">
                ...
                <button
                  onClick={handleReset}
                  className="inline-flex items-center gap-2 px-4 sm:px-6 py-2.5 sm:py-3 bg-blue-600 text-white rounded-lg font-heading font-bold text-sm sm:text-base transition-all duration-300 hover:shadow-lg active:scale-95"
                >
                  Try Again
                </button>
              </div>
        ...
        <div className="max-w-3xl mx-auto mt-6 sm:mt-8">
          <div className="bg-blue-50 border border-blue-200 rounded-xl p-3 sm:p-4 md:p-6">
            <div className="flex items-start gap-2 sm:gap-3">
              ...
              <div className="text-xs sm:text-sm md:text-base flex-1 min-w-0">
